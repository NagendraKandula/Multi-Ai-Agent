...
// 1. Initialize Model Providers with dedicated keys
const googleProvider = (key: string) => createGoogleGenerativeAI({ apiKey: key })('gemini-2.5-flash');
...
const supervisor = new Agent({
  ...
  instructions: `
    ...
    Based on the user's 'Selected Agents' list, call the relevant agents to build a plan.
    Moderate their discussion and synthesize a final startup roadmap.
  `,
  // Onboard all agents as tools for the supervisor
